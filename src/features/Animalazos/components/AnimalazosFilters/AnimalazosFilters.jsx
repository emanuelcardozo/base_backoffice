...
import AnimalesFilterSchema from 'features/Animalazos/schema/AnimalesFilterSchema'
...
const AnimalesFilters = ({ open, onCancel, onApply, initialFilters }) => {
  const { t } = useTranslation('features', { keyPrefix: 'Animalazos.filters' })

  const { handleChange, values, setValues, handleSubmit, setFieldValue } = useFormik({
    initialValues: initialFilters,
    validationSchema: AnimalesFilterSchema,
