...
import CompuFilterSchema from 'features/Compus/schema/CompuFilterSchema'
...
const CompuFilters = ({ open, onCancel, onApply, initialFilters }) => {
  const { t } = useTranslation('features', { keyPrefix: 'Compus.filters' })

  const { handleChange, values, setValues, handleSubmit, setFieldValue } = useFormik({
    initialValues: initialFilters,
    validationSchema: CompuFilterSchema,
