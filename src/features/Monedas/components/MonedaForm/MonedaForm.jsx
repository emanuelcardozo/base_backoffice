...
import CategorySchema from 'features/Monedas/schema/CategorySchema'

const direction = { xs: 'column-reverse', sm: 'row' }
function MonedaForm({ onCancel, onSubmit, initialValues, isSubmitting }) {
