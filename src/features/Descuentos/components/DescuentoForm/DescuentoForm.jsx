...
import CategorySchema from 'features/Descuentos/schema/CategorySchema'

const direction = { xs: 'column-reverse', sm: 'row' }
function DescuentoForm({ onCancel, onSubmit, initialValues, isSubmitting }) {
