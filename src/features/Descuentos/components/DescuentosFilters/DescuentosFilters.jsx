...
import CategoryFilterSchema from 'features/Descuentos/schema/CategoryFilterSchema'
...
const DescuentoFilters = ({ open, onCancel, onApply, initialFilters }) => {
...
export default DescuentoFilters
