...
import ComidaFilterSchema from 'features/Comidas/schema/ComidaFilterSchema'
...
const ComidaFilters = ({ open, onCancel, onApply, initialFilters }) => {
  const { t } = useTranslation('features', { keyPrefix: 'Comidas.filters' })

  const { handleChange, values, setValues, handleSubmit, setFieldValue } = useFormik({
    initialValues: initialFilters,
    validationSchema: ComidaFilterSchema,
