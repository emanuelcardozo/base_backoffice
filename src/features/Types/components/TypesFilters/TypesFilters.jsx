...
import CategoryFilterSchema from 'features/Types/schema/CategoryFilterSchema'
...
const TypesFilters = ({ open, onCancel, onApply, initialFilters }) => {
  const { t } = useTranslation('features', { keyPrefix: 'Types.filters' })
