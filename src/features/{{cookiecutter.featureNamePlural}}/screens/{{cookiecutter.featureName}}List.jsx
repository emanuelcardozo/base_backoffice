...
import useFetchCategories from '../hooks/useFetch{{cookiecutter.featureNamePlural}}'
import CategoriesTable from '../components/{{cookiecutter.featureNamePlural}}Table'
import { useNavigate } from 'react-router-dom'
import useFilters from 'hooks/useFilters.js'
import useDeleteCategory from '../hooks/useDelete{{cookiecutter.featureName}}'
