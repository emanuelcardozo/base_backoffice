...
import CategoryFilterSchema from 'features/Amigos/schema/CategoryFilterSchema'
...
const AmigoFilters = ({ open, onCancel, onApply, initialFilters }) => {
