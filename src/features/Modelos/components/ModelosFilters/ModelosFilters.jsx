...
import CategoryFilterSchema from 'features/Modelos/schema/CategoryFilterSchema'
...
const ModeloFilters = ({ open, onCancel, onApply, initialFilters }) => {
