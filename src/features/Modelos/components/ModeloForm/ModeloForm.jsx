...
import CategorySchema from 'features/Modelos/schema/CategorySchema'

const direction = { xs: 'column-reverse', sm: 'row' }
function ModeloForm({ onCancel, onSubmit, initialValues, isSubmitting }) {
