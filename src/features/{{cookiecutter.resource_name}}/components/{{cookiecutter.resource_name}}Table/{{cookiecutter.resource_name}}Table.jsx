...
const {{cookiecutter.resource_name}}Table = ({ onClickView, onClickEdit, onClickRemove, ...restOfProps }) => {
...
{{cookiecutter.resource_name}}Table.propTypes = {
  onClickView: PropTypes.func.isRequired,
  onClickEdit: PropTypes.func.isRequired,
  onClickRemove: PropTypes.func.isRequired,
}

export default {{cookiecutter.resource_name}}Table
